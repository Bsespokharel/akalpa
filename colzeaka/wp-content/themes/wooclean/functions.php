...
add_action( 'woocommerce_product_meta_start', 'aka_content_after_addtocart_button' );
function aka_content_after_addtocart_button(){
        ...
        if ($product->is_type( 'variable' )){
			...
			foreach ($available_variations as $key => $value) { 
				...
				// $val= asort($val);
				 ...
				 // print_r($value);
				$price_lists[$val['attribute_website-price']] = $value['display_price'];
            ...
            <?php foreach ($price_lists as $key => $value) { ?>
                <div class="row">
                                	<div class="col-md-6 brand-website">
